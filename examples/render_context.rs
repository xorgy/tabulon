...
#![allow(
    dead_code,
    reason = "This helper is shared across examples with slightly different needs."
)]

use std::sync::Arc;

use vello_hybrid::{RenderTargetConfig, Renderer};
use wgpu::{Adapter, Device, Features, Instance, Limits, Queue, Surface, SurfaceConfiguration};
